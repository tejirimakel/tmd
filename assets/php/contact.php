<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $recipient = "tejirimak@gmail.com";

        // Set the email subject.

        $subject = "TMDesigns - Mail From $first_name";
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F2F2F2">
                        ...
                        <tr>
                            ...
                            <td align="center" valign="top">
                                ...
                                <a href="https://www.tmd-agency.com" target="_blank"><img width="120" src="assets/images/logo-2.png" alt="logo"></a>
        ...
        $email_headers .= 'From:' . $first_name . ' ' . 'noreply@tmd-agency.com' . "\r\n";
